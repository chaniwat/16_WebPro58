...
public class StaffProfile extends SimpleTagSupport {
    ...
    public void doTag() throws JspException, IOException {
        ...
        out.println(
                ...
                "<div class=\"col-md-9\">\n" +
                "<select class=\"form-control\" name=\"staff-form-worksection\" id=\"staff-form-worksection\" data-default=\"" + staff.getSection().getId() + "\">"
        );
        for(Work.Section section : sections) {
            out.println("<option value=\"" + section.getId() + "\">" + section.getName_th() + "</option>");
        }
        out.println("</select>\n" +
                "</div>\n" +
                "</div>"
